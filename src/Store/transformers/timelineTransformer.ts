...
export const transformTimeLineResponse = (timelineRes: TimeLineImgApiRes): { trnsformedResponse: TransformedTimelineImgRes[] } => {
...
export const updateLikeCountTransformer = (
  ...
  if (affectedPost !== undefined && affectedPost !== null) {
    const currentCount = parseInt(affectedPost?.likes)
    const likes =
